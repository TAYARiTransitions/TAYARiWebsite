...
const CompFour = () => {
  const fadeInUp = {
    ...
    visible: {
      opacity: 1,
      y: 0,
      transition: { duration: 0.6 }, // Slightly longer duration for smoother effect
    },
  };
    ...
    <div>
      <div className="pri1 py-16 sm:py-20 px-10 sm:px-20">
        ...
        <div className="text-white">
          <p>
            What sets TAYARi Transitions apart is our holistic, hands-on approach. We’re not just about career advice; we’re about personal transformation. Our programs focus on:
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
          {/* Card 1 */}
          <motion.div
            className="border border-gray-600 h-[500px] rounded-t-xl text-white hover:bg-white hover:text-black transition-all"
            variants={fadeInUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: false, amount: 0.2 }}
            transition={{ delay: 0.1 }} // Slight delay for the first card
          >
            <img
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: false, amount: 0.2 }}
            transition={{ delay: 0.2 }} // Slight delay for the second card
          >
            <img
              src="https://img.freepik.com/free-photo/closeup-young-female-professional-making-eye-contact-against-colored-background_662251-651.jpg?t=st=1729778774~exp=1729782374~hmac=40e06dc53bbd6829e46f5700c4612cb07384f9e1d58c6ce7816d83358b1f03bd&w=740"
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: false, amount: 0.2 }}
            transition={{ delay: 0.3 }} // Slight delay for the third card
          >
            <img
              src="https://img.freepik.com/free-photo/closeup-young-female-professional-making-eye-contact-against-colored-background_662251-651.jpg?t=st=1729778774~exp=1729782374~hmac=40e06dc53bbd6829e46f5700c4612cb07384f9e1d58c6ce7816d83358b1f03bd&w=740"
              alt="Practical Tools and Insights"
              className="rounded-t-xl object-cover"
            />
            <div className="px-4 py-4">
              <h2 className="text-center text-xl pb-3 font-semibold">
