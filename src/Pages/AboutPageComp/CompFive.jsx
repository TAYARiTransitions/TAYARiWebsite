    ...
    <div>
      <div className="py-16 sm:py-20 px-10 sm:px-20 bg-white">
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }} // Only animate once when the element enters the viewport
        >
          ...
          >
            ...
            <ul className="leading-8 ml-5 text-md">
              <li className="list-disc">
                <span className="font-bold">Empowerment Drives Action:</span> We equip our participants with the tools, knowledge, and guidance they need to navigate life’s transitions and career challenges confidently. We empower each person to realize their potential, understanding that every journey is unique, and every goal achievable.
              </li>
              <li className="list-disc">
                <span className="font-bold">Collaboration and Connection Build Strength:</span> Our community is rooted in collaboration and mutual support. By bringing together participants, mentors, partners, and stakeholders, we create a vibrant network that shares experiences, inspires growth, and opens doors to new opportunities. We believe that connecting talents, ideas, and resources enriches us all.
              </li>
              <li className="list-disc">
