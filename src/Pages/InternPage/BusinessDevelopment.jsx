        ...
        <>
            <div className="fundManagementhomepage relative">
                <div className="fundManagementinternP min-h-screen flex justify-center items-center">
                    <h1 className="text-white text-4xl sm:text-5xl font-semibold text-center ">Business and Program <br /> Development Internship</h1>
                </div>
            </div>
            <NavBar />
<BTT/>
            <div className="abtInfo flex flex-col justify-center content-center items-center bg-white pt-10 py-14 relative">
                <div className=" w-full ">
                    <h2 className="text-center text-black opacity-90 text-2xl pb-10">
                        Discover our Internship opportunities in Business and Program Development.
                    </h2>
                    <div className="info pb-10 text-black opacity-90 text-2xl w-full ">
                        ...
                        <div className=" flex  justify-center content-center items-center w-full px-5 bg-gray-100 py-10">
                            <div className="max-w-6xl">
                                ...
                                <ul className="list-disc pl-14 leading-10  text-lg">
                                    <li className="pb-5">Currently pursuing a degree in Business Administration, Marketing, Development Studies, or a related field.
                                    </li>
                                </ul>
                                ...
                                <ul className="list-disc pl-14 leading-10  text-lg">
                                    <li>
                                        Strong communication, research & analytical, problem-solving and interpersonal skills.

                                    </li>
                                    <li>
                                        Passion for social impact and business-driven change.
                                    </li>
                                    <li>
                                        Proficiency in market analysis, financial modeling, and strategic planning.

                                    </li>
                                    <li>
                                        Creativity in branding and commercialization strategies.

                                    </li>
                                    <li className="pb-5">Understanding of investor relations and business negotiations.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <ul className="list-disc pl-14 leading-10  text-lg">
                            <li>Drive research to inform product development and identify emerging trends.
                            </li>
                            <li>
                                Recommend transition lines for prioritization and develop a phased rollout strategy.

                            </li>
                            <li>
                                Design product frameworks and strategies for commercialization.
                            </li>
                            <li>
                                Develop high-level market entry strategies and competitive positioning.

                            </li>
                            <li>
                                Cultivate strategic partnerships and support investor relations.
                            </li>
                            <li>
                                Establish monitoring systems to ensure continuous improvement and relevance.
                            </li>
                            <li>Contribute to brand strategy development, aligning it with organizational vision.
                            </li>
                            <li className="pb-5">Provide regular strategic updates and ensure cross-functional alignment with broader goals.</li>
                        </ul>
                            </div>
                        </div>
